...
\thesistitle{Desarrollo de un pipeline de aprendizaje continuo para chatbots basados en PLN} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
...
\director{Dr. Ing. Cardenas Rodrigo (FIUBA)} % El nombre del director, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \dirname
