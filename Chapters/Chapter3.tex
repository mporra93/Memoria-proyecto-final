...
\section{Implementación} 
  ...
  \begin{figure}[htbp]
    ...
    \caption{Ejemplo de frontend que muestra métricas para preguntas buenas y malas.}
    \label{fig:metricas2}
  \end{figure}
