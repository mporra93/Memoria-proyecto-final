...
\begin{enumerate}
  ...
  Modelos como BERT (por sus siglas en inglés, Bidirectional Encoder Representations from Transformers) y GPT (Generative Pre-trained Transformer) han transformado el campo del procesamiento de lenguaje natural (PLN), al ofrecer enfoques innovadores para comprender y generar texto.
...
\subsection{Retrieval Augmented Generation (RAG)}
  ...
  Además, RAG utiliza bases de datos vectoriales y la búsqueda semántica para recuperar información relevante, lo que mejora la precisión y relevancia de las respuestas del chatbot. Este enfoque es especialmente útil en situaciones donde se requiere información actualizada o especializada, como en consultas de productos o en el soporte técnico. La ilustración mostrada en la Figura~\ref{fig:arquitectura_rag}, representa el flujo de información en una arquitectura RAG desde la consulta inicial hasta la generación final de la respuesta.
...
\subsection{Ventajas y desventajas de los modelos RAG y Fine-Tuning}
  ...
  A continuación, se presenta en la tabla~\ref{tab:rag_vs_finetuning} las comparaciones de las principales ventajas y desventajas de los modelos RAG (Retrieval-Augmented Generation) y \textit{Fine-Tuning}. Esta comparación proporciona una visión clara de las características distintivas de cada enfoque, lo que permite una evaluación informada de su idoneidad en función de los requisitos específicos del entorno de implementación.
