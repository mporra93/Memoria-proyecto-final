...
\begin{itemize}
    ...
    \item Buenas preguntas: se presentan métricas específicas asociadas a preguntas que obtuvieron calificaciones altas, incluyendo el puntaje de calidad y un breve análisis de los factores que contribuyeron a una respuesta satisfactoria. Estas métricas son clave para identificar patrones positivos en el rendimiento del sistema, como se ilustra en la Figura~\ref{fig:metricasbuenas}.
...
\begin{table}[h]
    \centering
    \caption[Comparación de versiones del chatbot]{Comparación detallada de métricas entre diferentes versiones del chatbot, incluyendo número de trazas, costo y puntaje promedio.}
