...
Para las preguntas fuera de contexto, no se observaron cambios significativos en comparación con la versión 2. El sistema mantuvo guardrails personalizados para filtrar preguntas irrelevantes.
...
\begin{table}[h]
    \centering
    \caption[Comparación de versiones del chatbot]{Comparación detallada de métricas entre diferentes versiones del chatbot, que incluyen número de trazas, costo y puntaje promedio.}
