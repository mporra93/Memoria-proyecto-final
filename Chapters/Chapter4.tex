...
\begin{itemize}
    ...
    \newpage
    \item Malas preguntas: se visualizan métricas correspondientes a preguntas mal calificadas, lo que permite detectar fallos en el sistema y orientar acciones correctivas en los contextos o el flujo conversacional.
